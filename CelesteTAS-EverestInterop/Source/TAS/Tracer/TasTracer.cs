...
internal static class TasTracer {
    ...
    public static void TraceEvent(string evt, object? extra = null) {
        ...
        var json = JsonConvert.SerializeObject(newTrace,
            ...
            new JsonSerializerSettings {
                ...
                Converters = [
                    ...
                    // new FuncConverter<List<EffectReceiver>>(x => x.Select(y => (y == null ? "null" : ObjectUtils.ObjectComponentPath(y))).Join()),
