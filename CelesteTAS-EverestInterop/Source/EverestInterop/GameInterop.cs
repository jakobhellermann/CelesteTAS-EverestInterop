...
public static class GameInterop {
    ...
    public static bool IsActuallyLoading() {
        if (Manager.Controller.Inputs.GetValueOrDefault(Manager.Controller.CurrentFrameInTas) is { } current && current.ParentCommand is { } command && command.Is("SaveAndQuitReenter")) {
