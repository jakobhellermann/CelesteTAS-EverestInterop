...
public static class DebugInfo {
    ...
    public enum DebugFilter {
        ...
        All = RapidlyChanging | Tweens | Monsters | Camera | AttackSensors | AnimationClips | AllAnimatorLayers |
              Random,
    }
    ...
    public static string GetMonsterInfotext(MonsterBase monster, DebugFilter filter) {
        ...
        text +=
            $"HP:  {monster.postureSystem.FullPostureValue} (+{FormatNumber(monster.postureSystem.InternalInjury)})\n";
