...
public static class Hotkeys {
    ...
    private static void Initialize() {
        ...
        AllHotkeys[HotkeyID.FastForward] = FastForward = BindingToHotkey([InputKeys.RightShift], true);
        ...
        static Hotkey BindingToHotkey(List<InputKeys> binding, bool held = false) {
            return new(binding, [], true, held);
        }
